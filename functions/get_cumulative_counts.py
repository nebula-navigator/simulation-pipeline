...
def get_cumulative_counts(data,include='both'):
    ...
    # Handling both single and binary stars
    if 0 in k_values:
        ...
        # Updating counts for single data
    ...
    # Setting ik1 or ik2 to NaN if corresponding sm1 or sm2 is zero
    binary_data.loc[binary_data['sm1'] == 0, 'ik1'] = np.nan
    binary_data.loc[binary_data['sm2'] == 0, 'ik2'] = np.nan
    
    

    # Updating counts for binary data
