...
def suggest_visualizations():
    while True:
        ...
        if viz_choice == '1':
            ...
            plot_scatter(x_column, y_column, color_column if color_column else None, color_min if color_min else None, color_max if color_max else None, categorical_column if categorical_column else None)
        elif viz_choice == '3':
            ...
            plot_scatter_3d(x_column, y_column, z_column, color_column if color_column else None)
        elif viz_choice == '4':
            ...
            plot_pairplot([col.strip() for col in columns_list])
        elif viz_choice == '6':
            column_name = input("Enter the column name for violin plot: ")
            plot_violin(column_name)
        elif viz_choice == '7':
            plot_heatmap(data)
        elif viz_choice == '8':
            color_column = input("Enter the column name for color (optional): ")
            ...
            plot_3d_positions(color_column if color_column else None, color_min if color_min else None, color_max if color_max else None)
        elif viz_choice == '9':
            column_name = input("Enter the column name for bar plot of event frequencies: ")
            plot_event_frequencies(column_name)
        elif viz_choice == '10':
            include = input("Include 'single', 'binary', or 'both' stars: ").strip().lower()
            plot_cumulative_number_vs_stellar_types(include)
        elif viz_choice == '11':
            ...
            plot_distribution_of_masses(x_column, y_column)
        elif viz_choice == '13':
